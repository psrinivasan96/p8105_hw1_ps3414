...
```
Taking the mean of each element of the data set:

```{r}
mean(pull(early_january_weather, temp))
mean(pull(early_january_weather, dewp))
mean(pull(early_january_weather, humid))
mean(pull(early_january_weather, wind_dir))
mean(pull(early_january_weather, wind_speed))

```
Taking the mean works for all the elements except for wind direction. 
